<script lang="ts">
    ...
    const activeClasses = ["mx-4", "bg-gradient-to-r", "from-amethyst-200", "to-amethyst-400", "rounded", "p-1"]
...
<div class="m-10">
    <div class="m-10 mt-24 border-2 border-black bg-gradient-to-l from-amethyst-400 to-amethyst-700 rounded h-48 min-h-full flex items-center justify-center">
        <p
            class="text-5xl m-3 !text-stone-200"
            bind:this={currentStringElement}
        />
    </div>
    <div bind:this={textElement} class="grid grid-cols-4 w-full">
        <div>
